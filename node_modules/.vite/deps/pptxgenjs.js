...
function encodeSlideMediaRels(layout) {
  ...
  const loadNodeDeps = isNode ? () => __awaiter(this, void 0, void 0, function* () {
    ({ default: fs } = yield import("./node_fs-VEXY7BZM.js"));
    ({ default: https } = yield import("./node_https-XL2ELTAW.js"));
...
var PptxGenJS = class {
  ...
  writeFile(props) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (isNode) {
        const { promises: fs } = yield import("./node_fs-VEXY7BZM.js");
        const { writeFile } = fs;
